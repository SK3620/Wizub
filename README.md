...
## サービスへの想い・概要
このアプリは、「自分の好きなYouTube動画」と「日本語＋英語字幕の二重字幕」を組み合わせ、よりモチベーション高く、より直感的に英語を学習できるようにしたいという想いから生まれました。

動画の再生に連動して、動画内の細かいシーンごとに対応した英語字幕＆AIでより自然に訳された日本語字幕がリアルタイムで画面に表示されていきます。そして、ユーザーは英語学習に使用したい動画を自由に検索し、選ぶことができます。
