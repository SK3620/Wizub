...
**▶︎ [バックエンド（PHP Laravel）側のコードはこちら](https://github.com/SK3620/Wizub-Backend#wizub)**
...
### 3. 字幕の改善
- **現状・課題**  
  - 自動生成された日本語字幕を最初表示 → ChatGPT翻訳で、英語字幕を翻訳した日本語字幕を生成 → 元々表示されている自動生成された日本語字幕を強制で上書きしてしまう
  - ChatGPTもAIのため、翻訳精度にもばらつきがあり、もしかしたら、元々表示されていた自動生成された日本語字幕の方が適切と感じる場合もある...
- **目標**  
  - 元々表示されている自動生成された日本語字幕とChatGPT翻訳で英語字幕を翻訳した日本語字幕の両者を、ユーザー側で比較、選択できるようにする
